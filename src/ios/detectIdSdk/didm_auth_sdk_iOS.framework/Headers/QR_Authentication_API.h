 ...
 */
- (void)scanQRTransactionCode:(UIViewController *)_currentView forAccount:(Account *)account DEPRECATED_MSG_ATTRIBUTE("the method scanQRTransactionCode:(UIViewController *)_currentView forAccount:(Account *)account is no longer supported, please use instead qrAuthenticationProcess:(Account *)account data:(NSString *)data");

- (void)qrAuthenticationProcess:(Account *)account withQrContent:(NSString *)qrContent;
